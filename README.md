...
ESP32 ボード (2.8inch CYD 系: ST7789 240x320 + XPT2046 タッチ) で動作する CW Decoder です。  
...
- LCD: 2.8inch ST7789 240x320 (SPI 40MHz)
...
- TONE AUTO モード (デフォルト): 600〜1000Hz の最強ピークへゲート中心を自動同調。
...
- V2.0 (ESP32 版)
  ...
  - TONE AUTO モード（600〜1000Hz の最強ピークへ自動同調）を追加しデフォルト化
