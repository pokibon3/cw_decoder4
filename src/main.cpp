...
// 日付: 2026.07.11 バージョン 1.8
//  - CH32V003 / ST7735 サポートを削除 (CH32V006 + ST7789 専用に)
//  - Goertzel を3ビン化 (中心 + ±341.33Hz サイドビン)
//  - 中心/サイド比によるトーン判定でホワイトノイズを棄却
//  - 立ち上がり時は瞬時サイドも併用しインパルスノイズを棄却
//  - 速度推定を改良 (長点も利用して高速収束、低速側への変化率制限)
//  - 短点+長点ペア検出で20〜35wpm帯へ即時スナップ復帰
// 日付: 2026.07.12 バージョン 1.9
//  - トーン判定にヒステリシス導入 (ON 0.6x/3x, OFF 0.4x/2.5x)
//    SNR 0dB でのデコード誤りをほぼ解消
